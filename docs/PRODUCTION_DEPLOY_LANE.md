...
Step-by-step checklist, smoke expectations, and rollback: **[docs/LIVE_QWEN_ROLLOUT.md](./LIVE_QWEN_ROLLOUT.md)**.
...
- For live incidents, disable `QWEN_LIVE_ANALYSIS` first to return to demo-safe mode, then execute `docs/ROLLBACK_CHECKLIST.md`.
