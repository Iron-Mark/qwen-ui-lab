...
- [x] Product walkthrough script - `docs/media/PRODUCT_WALKTHROUGH_SCRIPT.md`
...
- [x] Live-analysis API route - `src/app/api/analyze-ui/route.ts`
...
| Live-analysis API route | Server route, env-gated |
| Build status | Pass |
