...
- Generated usable first-pass Tailwind class structures
...
4. **Type safety is a human responsibility.** AI generates `any`-adjacent code unless explicitly prompted for types.
