...
Copy into Marp, Slidev, or Google Slides speaker notes. One slide ≈ 45–60 seconds. **Marp-ready deck + export commands:** [docs/media/MEETUP_MEDIA.md](./media/MEETUP_MEDIA.md) and [docs/media/MEETUP_SLIDES.marp.md](./media/MEETUP_SLIDES.marp.md).
...
Shorter video script (30–60 s): **[docs/media/DEMO_SCRIPT.md](./media/DEMO_SCRIPT.md)**.
