...
- CSP report-only sink: `POST /api/security/csp-report` (production report-only header; see `docs/CSP_HARDENING_GUIDE.md` for log monitoring — violations are warn-level, not user-facing errors)
