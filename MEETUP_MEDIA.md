...
Recording and slide assets for qwen-ui-lab meetups. Pair with **[DEMO.md](./DEMO.md)** for the live script and **[content/demo-script.md](./content/demo-script.md)** for a 30–60 s promo cut.
...
- [ ] Prepare backup: static screenshots listed in [content/demo-script.md](./content/demo-script.md#backup-static-screenshot-sequence).
...
Follow the timed beats in **[content/demo-script.md](./content/demo-script.md)**. For a meetup-length cut, use the table in **[DEMO.md](./DEMO.md#10-minute-meetup-script)**.

---

## Slides (Marp)

Slide content lives in **[content/meetup-slides.marp.md](./content/meetup-slides.marp.md)** — eight slides derived from the outline in [DEMO.md](./DEMO.md#optional-slides-outline-markdown). One slide ≈ 45–60 seconds on stage.
...
**VS Code:** install the [Marp for VS Code](https://marketplace.visualstudio.com/items?itemName=marp-team.marp-vscode) extension and open `content/meetup-slides.marp.md`.
...
npx @marp-team/marp-cli content/meetup-slides.marp.md --pdf -o content/meetup-slides.pdf

# PowerPoint (editable in Google Slides / Keynote import)
npx @marp-team/marp-cli content/meetup-slides.marp.md --pptx -o content/meetup-slides.pptx

# HTML (self-contained deck)
npx @marp-team/marp-cli content/meetup-slides.marp.md --html -o content/meetup-slides.html
```
...
| [docs/PWA.md](./docs/PWA.md) | Install on Android (Chrome + optional Play Store TWA) |
| [content/demo-script.md](./content/demo-script.md) | 30–60 s voiceover script |
