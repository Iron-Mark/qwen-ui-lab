...
export function createManifestConfig(): MetadataRoute.Manifest {
  return {
    ...
    screenshots: [
      {
        src: "/screenshots/A1-Workflow-Home/desktop-light.png",
        sizes: "1440x1000",
        type: "image/png",
        form_factor: "wide",
        label: "Workflow home desktop",
      },
      {
        src: "/screenshots/A2-Upload-Flow/mobile-light.png",
        sizes: "390x844",
        type: "image/png",
        form_factor: "narrow",
        label: "Upload workflow mobile",
      },
    ],
    launch_handler: {
