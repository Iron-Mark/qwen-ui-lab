export const en = {
  ...
  account: {
    ...
    title: "Personalize this browser tab",
    subtitle:
      "Choose the name attached to saved analyses in this tab. Nothing here creates an account, sends email, or leaves your browser.",
    ...
    displayNameDesc:
      "Use a short label for the header and recent analysis list. Clear it to return to Guest.",
    displayNameLabel: "Name",
    displayNamePlaceholder: "e.g. Alex",
    saveDisplayName: "Save name",
    signOut: "Clear local profile",
    magicLinkTitle: "Optional email label",
    magicLinkDesc:
      "Preview an email-based label without sending mail or creating an account.",
    emailLabel: "Email",
    emailPlaceholder: "you@example.com",
    sendMagicLink: "Start local preview",
  ...
  designSystem: {
    ...
    keyboardHelp:
      "Press / to search, j and k to move through the list. Alt+1–4 changes domain; Alt+Shift+1–3 toggles tier.",
