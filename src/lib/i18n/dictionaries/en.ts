export const en = {
  hero: {
    ...
    title: "Screenshot to React scaffolds",
    subtitle:
      "Upload a UI screenshot, get a layout plan, and export React + Tailwind in minutes.",
  ...
  account: {
    ...
    title: "Name saved work in this browser",
    subtitle:
      "This is not a real sign-in. It only labels saved analyses in this tab; nothing is sent to a server and no account is created.",
    statusTitle: "What this controls",
    statusDesc: "Local-only preferences for the screenshot workflow.",
    currentLabelTitle: "Current label",
    storedInTitle: "Stored in",
    storedInBody: "This browser tab only",
    notAccountTitle: "Not a login",
    notAccountBody: "No password, OAuth, server account, or outbound email.",
    modeGuest: "Guest",
    modeNamed: "Local profile",
    savedScaffoldsAs: "Saved analyses will show as “{name}”",
    displayNameTitle: "Session label",
    displayNameDesc:
      "Set the name shown in the header and recent analysis list. Leave it blank to use Guest.",
    displayNameLabel: "Name for this tab",
    displayNamePlaceholder: "e.g. Alex",
    saveDisplayName: "Use this name",
    signOut: "Clear local profile",
    magicLinkTitle: "Optional email demo",
    magicLinkDesc:
      "Preview how a future email sign-in could feel. It does not send mail or create an account.",
    emailLabel: "Email",
    emailPlaceholder: "you@example.com",
    sendMagicLink: "Preview email sign-in",
    magicLinkPendingTitle: "Local confirmation only",
    magicLinkPendingBody:
      "No email was sent to {email}. Confirm below to use that email name locally in this tab.",
    confirmMagicLink: "Confirm locally",
