export const en = {
  ...
  account: {
    eyebrow: "Profile",
    title: "Profile",
    subtitle: "Manage the name shown in saved analyses and the app header.",
    profilePreviewDesc: "Used in saved analyses",
    modeGuest: "Guest profile",
    modeNamed: "Named profile",
    displayNameDesc:
