...
export const zh = {
  ...
  uploadFlow: {
    ...
    statusAnalysisComplete: "分析完成 — 打开预览查看生成组件。",
    ...
    exportReadmeCorrections: "手动修正",
    exportReadmeNoCorrections: "未记录手动修正。",
    exportReadmeReviewNotes: "复核提示",
    exportReadmeReviewSummary: "{count} 个低置信度元素需要在合并前复核。",
    exportReadmeReviewClear: "合并前请按清单复核。",
