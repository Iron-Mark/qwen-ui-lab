...
export const zh = {
  hero: {
    ...
    benefitDesignBody: "使用结果前先检查 TSX、Design.md 和项目交接文件。",
  ...
  share: {
    ...
    notFoundStorageHint:
      "持久短链接需要存储支持。临时链接可能在冷启动或重新部署后失效。",
  },
  account: {
    eyebrow: "资料",
    title: "资料",
  ...
  uploadFlow: {
    ...
    toastFallback: "本地分析已就绪",
    toastAnalyzeFailed: "正在使用本地分析",
