...
export const zh = {
  ...
  account: {
    ...
    title: "为本浏览器中的作品命名",
    subtitle:
      "这不是正式登录。它只会给当前标签页中的分析记录加上本地标签；不会发送到服务器，也不会创建账户。",
    statusTitle: "这个页面控制什么",
    statusDesc: "仅用于截图工作流的本地偏好设置。",
    currentLabelTitle: "当前标签",
    storedInTitle: "保存位置",
    storedInBody: "仅当前浏览器标签页",
    notAccountTitle: "不是登录",
    notAccountBody: "没有密码、OAuth、服务端账户或对外邮件。",
    modeGuest: "访客",
    modeNamed: "本地资料",
    savedScaffoldsAs: "已保存分析会显示为“{name}”",
    displayNameTitle: "会话标签",
    displayNameDesc:
      "设置页眉和最近分析列表中显示的名称。留空则使用访客。",
    displayNameLabel: "本标签页中的名称",
    displayNamePlaceholder: "例如 Alex",
    saveDisplayName: "使用这个名称",
    signOut: "清除本地资料",
    magicLinkTitle: "可选邮箱演示",
    magicLinkDesc: "预览未来邮箱登录的交互感受。不会发送邮件，也不会创建账户。",
    emailLabel: "邮箱",
    emailPlaceholder: "you@example.com",
    sendMagicLink: "预览邮箱登录",
    magicLinkPendingTitle: "仅本地确认",
    magicLinkPendingBody:
      "没有向 {email} 发送邮件。点击下方确认，即可在本标签页使用该邮箱名称。",
    confirmMagicLink: "本地确认",
    backToDemo: "返回实时演示",
