...
import { ThemedChartPreview } from "@/components/molecules/ThemedChartPreview";
import { LawInformationCard } from "@/components/molecules/LawInformationCard";
import { LawOfUxCard } from "@/components/molecules/LawOfUxCard";
...
import { UiLawComplianceChecklist } from "@/components/organisms/UiLawComplianceChecklist";
import { LawReferencePanel } from "@/components/organisms/LawReferencePanel";
...
import { LAWS_OF_UX } from "@/data/lawsOfUx";
...
const statSnippet = `import { StatCard } from "@/components/molecules/StatCard";
...
const statDownSnippet = `import { StatCard } from "@/components/molecules/StatCard";
...
export function ExampleInput() {
  ...
  },
  {
    ...
    sourcePath: "components/atoms/ThemeToggle.tsx",
    props: [
      { name: "(none)", type: "—", description: "Self-contained; reads ThemeProvider context." },
    ],
    preview: <ThemeToggle />,
    code: `import { ThemeToggle } from "@/components/atoms/ThemeToggle";
...
export function ExampleThemeToggle() {
  ...
  },
  {
    ...
    sourcePath: "components/atoms/ExportButton.tsx",
    props: [
    ...
    code: `import { ExportButton } from "@/components/atoms/ExportButton";
...
export function ExampleExportButton() {
  ...
  },
  {
    ...
    sourcePath: "components/atoms/QuickActionButton.tsx",
    props: [
      { name: "action", type: "{ label: string; icon: string }", description: "Shortcut metadata." },
    ],
    preview: <QuickActionButton action={quickActions[0]} />,
    code: `import { QuickActionButton } from "@/components/atoms/QuickActionButton";
...
export function ExampleSnippetPreview() {
  ...
  },
  {
    ...
    sourcePath: "components/molecules/StatCard.tsx",
    props: [
  ...
  },
  {
    ...
    sourcePath: "components/molecules/RevenueCard.tsx",
    props: [
      { name: "data", type: "RevenuePoint[]", description: "Monthly revenue series." },
    ],
    preview: <RevenueCard data={revenueData} />,
    code: `import { RevenueCard } from "@/components/molecules/RevenueCard";
...
export function ExampleRevenueCard() {
  ...
  },
  {
    ...
    sourcePath: "components/molecules/UploadDropzone.tsx",
    props: [
    ...
    code: `import { UploadDropzone } from "@/components/molecules/UploadDropzone";
...
export function ExampleUploadDropzone() {
  ...
  },
  {
    ...
    sourcePath: "components/molecules/PerformanceLineChart.tsx",
    props: [
    ...
    code: `import { PerformanceLineChart } from "@/components/molecules/PerformanceLineChart";
...
export function ExamplePerformanceLine() {
  ...
  },
  {
    ...
    sourcePath: "components/molecules/ChannelDonutChart.tsx",
    props: [
    ...
    code: `import { ChannelDonutChart } from "@/components/molecules/ChannelDonutChart";
...
export function ExampleChannelDonut() {
  ...
  },
  {
    ...
    sourcePath: "components/organisms/Header.tsx",
    preview: (
      <div className="overflow-hidden rounded-lg border border-border">
        <Header />
      </div>
    ),
    code: `import { Header } from "@/components/organisms/Header";
...
export function ExampleHeader() {
  ...
  },
  {
    ...
    sourcePath: "components/organisms/WorkflowBanner.tsx",
    preview: <WorkflowBanner />,
    code: `import { WorkflowBanner } from "@/components/organisms/WorkflowBanner";
...
export function ExampleActivityList() {
  ...
  },
  {
    ...
    sourcePath: "components/organisms/ChartPreview.tsx",
    props: [
    ...
    code: `import { ChartPreview } from "@/components/organisms/ChartPreview";
...
const uilawsCatalog: AtomicCatalogEntry[] = [
  {
    ...
    sourcePath: "components/molecules/LawInformationCard.tsx",
    ...
    code: `import { LawInformationCard } from "@/components/molecules/LawInformationCard";
...
export function ExampleLawInformationCard() {
  ...
  },
  {
    ...
    sourcePath: "components/organisms/UiLawComplianceChecklist.tsx",
    principles: ["fitts", "hick", "jakob", "consistency", "contrast"],
    preview: <UiLawComplianceChecklist />,
    code: `import { UiLawComplianceChecklist } from "@/components/organisms/UiLawComplianceChecklist";
...
export function ExampleComplianceChecklist() {
  ...
  },
  {
    ...
    sourcePath: "components/organisms/LawReferencePanel.tsx",
    principles: ["fitts", "hick", "jakob", "consistency", "contrast", "white-space"],
    preview: <LawReferencePanel productOnly />,
    code: `import { LawReferencePanel } from "@/components/organisms/LawReferencePanel";
...
const lawsOfUxCatalog: AtomicCatalogEntry[] = LAWS_OF_UX.map((law) => ({
  ...
  sourcePath: "components/molecules/LawOfUxCard.tsx",
  lawId: law.id,
  principles: law.relatedUiLawIds,
  preview: <LawOfUxCard law={law} />,
  code: `import { LawOfUxCard } from "@/components/molecules/LawOfUxCard";
import { lawOfUxById } from "@/data/lawsOfUx";
