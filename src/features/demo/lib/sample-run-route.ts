...
export function createSampleRunRouteMetadata(): Metadata {
  return createRouteMetadata({
    title: "Sample run",
    description:
      "Run dashboard, sign-in, mobile, landing, settings, and shop layouts. Inspect detections and download a React/Tailwind export package.",
    path: "/demo",
    keywords: [
...
export function getSampleRunRouteStructuredDataInput() {
  return {
    title: "Sample run",
    description:
      "Guided layouts with component drafts for common UI archetypes.",
    path: "/demo",
